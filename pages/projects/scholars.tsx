...
const Scholars = () => {
	...
	const features = [
		...
		},
		{
			...
			info: "Feature for site and business admins which allows them to create, update, and delete articles which can be read by students on the platform. This tool features the react-rte and react-html-parser npm packages.",
		...
		},
		{
			...
			info: "Feature for students so that they can explore career resources and have access to the start-up owned podcast. Each resource has its own API to which requests are made and information is received from. Each request tends to be dependent on the page breadcrumbs, therefore it is dynamic and loads only what is requested by the user.",
		...
		},
		{
			title: "Job Board",
			tags: "Notifications",
			info: "Feature for students which allows them to see public job board positions, to which they can apply and notify the business about their interest in the position.",
		...
		},
		{
			...
			info: "Feature for business partners which allows them to see an assortment of information about their recruiting efforts (page views, number of applicants, messages, response rates, & more). The tool also features a popular npm package, chart-js, which is used to better see the demographics of applicants of certain positions.",
		...
		},
		{
			...
			info: "Wrote documentation on the implementation of the ATS integration for developers at Greenhouse, so that they could approve our design patterns and security measures for integrating their platform onto ours.",
