				...
				<div className="w-full">
					...
					<div className="flex flex-wrap md:flex-no-wrap  justify-center">
						<Testimonial
							...
							imgSrc="/imgs/masheed.jpg"
						/>
						{/* <Testimonial
										name="Francisco Jimenez"
										title="TallySight Head of Engineering"
										email="evan@quikfixjobs.com"
										statement="Allan was able to quickly jump into the TallySight platform and add high-level features. He has proved to be a reliable developer with a great understanding for React and Redux. His programming skills, matched with his enthusiasm, would make a great addition to any team!"
