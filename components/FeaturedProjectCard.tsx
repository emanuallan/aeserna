...
const FeaturedProjectCard: React.FC<FeaturedProjectCardProps> = ({ title, info, imgSrc, icons, color }) => {
	return (
		<div className="w-full">
			<div className="bg-white shadow-2xl rounded-lg mb-6 tracking-wide">
				...
				<div className="px-4 py-2 mt-2 uppercase">
					...
					<div className=" flex justify-between items-center  mb-3 mt-6">
						...
						<div>
							<a href="#" className="text-blue-500 text-sm mr-4 ">
								My Work
							</a>
						</div>
					</div>
